...
public class ModelSettingFragment extends BaseLazyFragment {
    ...
    protected void init() {
        ...
        findViewById(R.id.llSearchTv)。setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View 次浏览) {
                FastClickCheckUtil.check(次浏览);
        ...
        findViewById(R.id.llIjkCachePlay)。setOnClickListener((次浏览 -> onClickIjkCachePlay(次浏览)));
        findViewById(R.id.llClearCache)。setOnClickListener((次浏览 -> onClickClearCache(次浏览)));
    }
